...
public class PTFandCheque extends ForwardeeMethods
{ 
   @Test
   public void RefundByPTFandCheque() throws InterruptedException, SQLException
   {
	   TestConnectivity con =  new TestConnectivity();
		 ...
		 RefundMethod("PTF and Cheque");               // TES , PTF
		 GODate("21","Feb","2016");
		 GOTime();
		 SaveNProceed();
		 Thread.sleep(1000);
